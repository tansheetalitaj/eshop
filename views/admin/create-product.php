                        ...
                        <div class="mb-3">
                            <label for="language" class="form-label">Category</label>
                             <div class="input-group mb3">
                            	...
                            	<input id="category" type="text" name="category" class="form-control" aria-label="Text input with dropdown button" value="<?php if(isset($items[0]['category'])){echo $items[0]['category'];} ?>">
                        	</div>
                        </div>
                        <div class="mb-3">
